                    ...
                    <div className="hero rounded-xl bg-[url(../../public/images/cool-background.png)]">
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-xl py-5 lg:py-10">
                                ...
                                <h1 className="text-3xl font-bold font-rale">Sarah Johnson</h1>
                                ...
                                <p className="mb-5 text-sm">I recently booked a tour package to Thailand,
                    ...
                    <div className="hero rounded-xl bg-[url(../../public/images/cool-background.png)]">
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-xl py-5 lg:py-10">
                                ...
                                <h1 className="text-3xl font-bold font-rale">David Lee</h1>
                                ...
                                <p className="mb-5 text-sm">I booked a solo trip to Vietnam and Cambodia through TourifyNow 
                    ...
                    <div className="hero rounded-xl bg-[url(../../public/images/cool-background.png)]">
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-xl py-5 lg:py-10">
                                ...
                                <h1 className="text-3xl font-bold font-rale">Emily Chen</h1>
                                <div className="rating mt-3 mb-5">
                                ...
                                <p className="mb-5 text-sm">My friends and I booked a last-minute getaway to Bali 
